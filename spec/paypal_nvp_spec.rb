...
describe "PaypalNVP" do
  ...
  describe "Paypal Call" do
    ...
    context "success" do
      let(:paypal) { PaypalNvp.new(:user => "team_1220115929_biz_api1.example.com", :pass => "1240413944", :cert => "acert4qi4-AdHZBSIbxJNpN30UcsogreatcertP", :version => "72.0") }
    ...
    context "ssl" do
      ...
      it "should do an ssl call" do
        ...
        http.should_receive(:request_post).with("/nvp", "USER=team_1220115929_biz_api1.example.com&SIGNATURE=&PWD=").and_return(http_response)
